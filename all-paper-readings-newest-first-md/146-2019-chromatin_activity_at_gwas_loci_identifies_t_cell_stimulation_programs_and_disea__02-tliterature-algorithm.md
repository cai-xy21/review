...
- PMID：31548716
- Code/Tool：CHEERS GitHub：https://github.com/trynkaLab/CHEERS

## 算法视角定位
本文的算法定位是：CHEERS models subtle quantitative chromatin-state changes and tests enrichment of disease-associated SNPs across immune cell states。。在 81-94 这一组文献中，它用于补齐 TCR/BCR tooling、sample multiplexing、多模态测量、RNA/ATAC regulatory inference 或 GWAS-to-cell-state enrichment 的方法拼图。

## 输入与输出
- 输入：Human T cells and macrophages stimulated with disease-relevant cytokines；raw sequencing in EGA：ATAC-seq EGAS00001003501，H3K27ac EGAS00001002749。
...
### 2. 关键计算模块
CHEERS models subtle quantitative chromatin-state changes and tests enrichment of disease-associated SNPs across immune cell states。 这是该条目最值得在 method report 中展开的算法或 workflow 层贡献。
...
## 数据可用性评估
- DOI 和 accession：https://doi.org/10.1038/s41588-019-0493-9；Human T cells and macrophages stimulated with disease-relevant cytokines；raw sequencing in EGA：ATAC-seq EGAS00001003501，H3K27ac EGAS00001002749。
- 代码：CHEERS GitHub：https://github.com/trynkaLab/CHEERS
