...
- PMID：33098772
- Code/Tool：Data portal https://buenrostrolab.shinyapps.io/skinnetwork/；analysis built around paired RNA/ATAC matrices and regulatory program inference。

## 算法视角定位
本文的算法定位是：combinatorial indexing joint RNA and ATAC profiling；correlates chromatin accessibility with later RNA expression to define chromatin potential。。在 81-94 这一组文献中，它用于补齐 TCR/BCR tooling、sample multiplexing、多模态测量、RNA/ATAC regulatory inference 或 GWAS-to-cell-state enrichment 的方法拼图。

## 输入与输出
- 输入：Homo sapiens cell lines and Mus musculus skin/brain/lung；GEO GSE140203；BioProject PRJNA588784；SRA SRP229493；processed data and Shiny skin network portal。
...
### 2. 关键计算模块
combinatorial indexing joint RNA and ATAC profiling；correlates chromatin accessibility with later RNA expression to define chromatin potential。 这是该条目最值得在 method report 中展开的算法或 workflow 层贡献。
...
## 数据可用性评估
- DOI 和 accession：https://doi.org/10.1016/j.cell.2020.09.056；Homo sapiens cell lines and Mus musculus skin/brain/lung；GEO GSE140203；BioProject PRJNA588784；SRA SRP229493；processed data and Shiny skin network portal。
- 代码：Data portal https://buenrostrolab.shinyapps.io/skinnetwork/；analysis built around paired RNA/ATAC matrices and regulatory program inference。
